  ...
  if (difference <= 10) {
    if (guessValue > firstValue) {
      document.getElementById("Hint").textContent =
        "You're close, but try a smaller number.";
    } else if (guessValue < firstValue) {
      document.getElementById("Hint").textContent =
        "You're close, but try a larger number.";
    } else {
      document.getElementById("Hint").textContent =
        "You're very close! Try a slightly different number.";
    }
  } else {
    if (guessValue > firstValue) {
      document.getElementById("Hint").textContent =
        "You're quite far away. Try a smaller number.";
    } else {
      document.getElementById("Hint").textContent =
        "You're quite far away. Try a larger number.";
    }
  }
}
function backToPage() {
